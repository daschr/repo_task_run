...
use crate::common::{ENTRA_CLIENT_ID, ENTRA_CLIENT_SECRET, ENTRA_TENANT_ID};

pub fn get_entra_groups_of_user(upn: &str) -> Result<HashSet<String>, Box<dyn std::error::Error>> {
